...
module.exports = function(Resource, resource, association) {
  // access points
  var subResourceName = resource.associationOptions.subResourceNameFormatter ?
    resource.associationOptions.subResourceNameFormatter(association.target.options.name.singular) :
